...
const folderPath = process.argv[3]; // Folder path to encrypt/decrypt

if (!folderPath) {
    console.log('Usage: node folderCrypto.js <encrypt|decrypt> <folderPath>');
    process.exit(1);
}
...
if (action === 'encrypt') {
    ...
    console.log(`Decrypting folder: ${folderPath}`);
